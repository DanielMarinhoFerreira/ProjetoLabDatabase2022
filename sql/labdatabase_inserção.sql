...
WITH DATA_COTACOES AS (
    ...
    SELECT  'AAZQ11' , '03-10-2023','9.28','1.28', '9.28','9.95', '9.28', '9.95','24.037.284', '05-10-2023' FROM DUAL UNION ALL
    SELECT 'ABCP11' , '03-10-2023', '66.81', '0.89', ' 63.47', '109.7','66.84','66.90','4.709.082','05-10-2023'  FROM DUAL UNION ALL
    SELECT  'AFHI11' , '03-10-2023', '95.70', '1.07', '90.30', '103.70','95.98','95.70','3.343.095','05-10-2023'  FROM DUAL UNION ALL
    SELECT  'AIEC11' , '03-10-2023','63.16', '1.16','60.52',' 70.86','63.63','63.16','4.824.987', '05-10-2023'  FROM DUAL UNION ALL
    SELECT  FROM DUAL 
    )
