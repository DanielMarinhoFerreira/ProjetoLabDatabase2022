...
CREATE TABLE ADMINISTRADORES (
    ID NUMBER GENERATED ALWAYS AS IDENTITY, -- AUTO INCREMENTADA
...
CREATE TABLE COTACOES (
    ID NUMBER GENERATED ALWAYS AS IDENTITY, -- AUTO INCREMENTADA
    TICKER VARCHAR2(6 char) NOT NULL,
    DATA_COTA VARCHAR2(10 CHAR) NOT NULL,
    ...
    OTA_ATUAL NUMBER(38) NOT NULL,
    MES VARCHAR2(10 char) NOT NULL
);
...
ALTER TABLE FUNDOS
    ...
    REFERENCES ADMINISTRADORES (CNPJ);
